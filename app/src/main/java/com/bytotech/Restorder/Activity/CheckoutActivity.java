...
import com.bytotech.Restorder.paytmIntegration.Api;
import com.bytotech.Restorder.paytmIntegration.Checksum;
import com.bytotech.Restorder.paytmIntegration.Constants;
import com.bytotech.Restorder.paytmIntegration.Paytm;
...
public class CheckoutActivity extends AppCompatActivity implements PaymentResultListener {
    ...
    String merchantId="mkqrkg66337193948105";
    String merchantKey="Tp7FdW#GgHWn#l17";
    /*generating checksum for paytm...*/
    private void generateCheckSumPay() {
        total = ((TextView) findViewById(R.id.tvTotal)).getText().toString().trim();
        ...
        Call<Checksum> call = apiService.getChecksum(
                ...
                paytm.getTxnAmount(),
                paytm.getWebsite(),
                "https://securegw.paytm.in/theia/paytmCallback?ORDER_ID="+paytm.getOrderId(),
    ...
    String midPay = "";
    String respCodePay = "";
    String paymentModePay = "";
    String bankTxnIdPay = "";
    String currencyPay = "";
    String gatewayNamePay = "";
    String respMsgPay = "";

    /*getting paytm response from bundle */
    private void getDataPayment(Bundle s ) {
        ...
        if (respCodePay == "01") {
            try {
                ...
                request.add("menu_id", menu_id);
                request.add("menu_qty", menu_qty);
                request.addProperty("payment_id", TXNIDPay);
                request.addProperty("total_price", total);
                request.addProperty("payment_type", "PAY");
                request.addProperty("user_id", preferenceUtils.getUserId());
            ...
            Toast.makeText(this, respMsgPay, Toast.LENGTH_SHORT).show();
        }
    }
